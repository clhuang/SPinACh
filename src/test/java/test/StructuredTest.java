...
public class StructuredTest {
    ...
    private static final String ARG_CLASSIFIER_LOC = "src/test/resources/argumentClassifierEFA.gz";
    private static final String PRED_CLASSIFIER_LOC = "src/test/resources/predicateClassifierA.gz";

    private static final boolean LOAD_ARG_CLASSIFIER = true;
    private static final boolean LOAD_PRED_CLASSIFIER = true;

    public static final int BURN_IN_PERIOD = 800000;
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        argumentClassifier.setConsistencyMode(true, false);
    ...
    private static ArgumentClassifier initArgClassifier() {
        ...
        PerceptronClassifier argumentClassifierPerceptron =
                new PerceptronClassifier(argumentFeatureGenerator.getAllowedNonStructuralFeatures(),
                        ArgumentClassifier.getLabelSet(trainingFrames), NUM_EPOCHS);
        System.out.println("Created arg classifier perceptron");
